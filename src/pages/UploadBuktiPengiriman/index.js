...
export default class UploadBuktiPengiriman extends Component{
    constructor(props){
        super(props);
        this.state={
            collect:[],
    ...
    async getDataItem(){
        ...
        .then(
            res => {
                ...
                .then(
                    respon => {
                        console.log(`respon.image :`, respon.data.image_pengiriman)
                        this.setState({images: respon.data.image_pengiriman})
    ...
    updateStatus(){
        if(this.state.images == "" || this.state.images == undefined){
            alert("Tidak ada bukti surat jalan!")
        } else {
            const dataUpdate = {
            ...
            <View style={{backgroundColor:'#73A3EC', height:'100%'}}>
                ...
                <View style={{paddingLeft:normalize(30), paddingRight:normalize(30), paddingBottom:normalize(20)}}>
                    <View style={{height:normalize(350), width:'100%', borderRadius:20, backgroundColor:'#fff', marginTop:normalize(50)}}>
                        <Text style={{fontFamily:'RedHatDisplay-Bold', fontSize:normalize(24), textAlign:'center', paddingTop:normalize(10)}}>Terima Bukti Surat Jalan</Text>
                    ...
                    <Button onPress={() => {this.props.navigation.push('CustomerProgress')}} full style={{backgroundColor:'#E78181', height:normalize(40), borderRadius:10, marginTop:normalize(20)}} >
